...
export FIP_PATIENCE := env("FIP_PATIENCE", "1000")
export FIP_BATCH_SIZE := env("FIP_BATCH_SIZE", "128")
export FIP_LEARNING_RATE := env("FIP_LEARNING_RATE", "0.001")
...
export FIP_WINDOW_MINUTES := env("FIP_WINDOW_MINUTES", "15")
...
export FIP_FUSION_HIDDEN_SIZE := env("FIP_FUSION_HIDDEN_SIZE", "64")
